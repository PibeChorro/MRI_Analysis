...
spm_mkdir(fullfile(derived_dir), subNames, 'MRI/analysis/glm/TrickVersionMagicMomentPostRevelation');
...
for s = 1:length(subNames)
    beta_loc            = fullfile(derived_dir,subNames{s},'MRI/analysis/glm/TrickVersionMagicMomentPostRevelation');
