...
spm_mkdir(fullfile(derived_dir), subNames, 'MRI/analysis/first_level_analysis/ModelEveryVideo');
...
for s = 1:length(subNames)
    ...
    beta_loc            = fullfile(derived_dir,subNames{s},'MRI/analysis/first_level_analysis/ModelEveryVideo');
